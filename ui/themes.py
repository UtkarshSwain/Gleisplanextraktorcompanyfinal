...
QLabel { color: #cccccc; }
QComboBox { background-color: #4a4a4a; color: #ffffff; border: 1px solid #555555; border-radius: 4px; padding: 1px 0 1px 3px; selection-background-color: #0078d7; selection-color: #ffffff; }
QComboBox::drop-down { border: 0px; width: 20px; }
QComboBox QAbstractItemView { background-color: #4a4a4a; color: #ffffff; selection-background-color: #0078d7; }
...
QTableView { background-color: #3c3c3c; color: #cccccc; gridline-color: #555555; selection-background-color: #0078d7; selection-color: #ffffff; border: 1px solid #4a4a4a; }
...
QTreeWidget { background-color: #3c3c3c; color: #cccccc; gridline-color: #555555; selection-background-color: #0078d7; selection-color: #ffffff; border: 1px solid #4a4a4a; }
...
QSlider::handle:horizontal { background: #0078d7; border: 1px solid #0078d7; width: 18px; margin: -5px 0; border-radius: 9px; }
...
QLabel { color: #333333; }
QComboBox { background-color: #e0e0e0; color: #000000; border: 1px solid #c0c0c0; border-radius: 4px; padding: 1px 0 1px 3px; selection-background-color: #a0d0ff; selection-color: #000000; }
QComboBox::drop-down { border: 0px; width: 20px; }
QComboBox QAbstractItemView { background-color: #e0e0e0; color: #000000; selection-background-color: #a0d0ff; }
QProgressBar { background-color: #e0e0e0; color: #333333; border: 1px solid #c0c0c0; border-radius: 4px; text-align: center; }
QProgressBar::chunk { background-color: #a0d0ff; border-radius: 4px; }
QTableView { background-color: #ffffff; color: #333333; gridline-color: #e0e0e0; selection-background-color: #a0d0ff; selection-color: #000000; border: 1px solid #c0c0c0; }
...
QTreeWidget { background-color: #ffffff; color: #333333; gridline-color: #e0e0e0; selection-background-color: #a0d0ff; selection-color: #000000; border: 1px solid #c0c0c0; }
QTreeWidget::item:selected { background-color: #a0d0ff; color: #000000; }
...
QSlider::handle:horizontal { background: #a0d0ff; border: 1px solid #a0d0ff; width: 18px; margin: -5px 0; border-radius: 9px; }
QSplitter::handle { background-color: #c0c0c0; }
QSplitter::handle:hover { background-color: #a0d0ff; }
QMenuBar { background-color: #f0f0f0; color: #333333; }
QMenuBar::item:selected { background-color: #a0d0ff; color: #000000; }
