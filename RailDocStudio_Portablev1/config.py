...
# External tool paths - resolved dynamically for portable distribution
from paths import get_tesseract_path, get_poppler_path

TESSERACT_PATH = str(get_tesseract_path())
POPPLER_PATH = str(get_poppler_path())
