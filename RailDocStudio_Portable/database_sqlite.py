...
# Database file location - uses paths module for portable distribution
...
def delete_custom_symbol(symbol_name: str) -> bool:
    ...
    from paths import get_custom_symbol_templates_dir
    try:
        import shutil
        templates_dir = get_custom_symbol_templates_dir(symbol_name)
