...
from paths import get_custom_symbols_path, get_training_data_dir
...
class NewSymbolDetector:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.config_path = Path(config_path) if config_path else get_custom_symbols_path()
        self._load_config()
...
class SymbolRetrainer:
    ...
    def __init__(self, base_model_path: str):
        ...
        self.training_data_dir = get_training_data_dir()
